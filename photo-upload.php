<?php 
	...
	if(isset($_SESSION['sessionFirstname']) && isset($_SESSION['sessionLastname']))
	{
		...
		echo "<div id=\"h2title\">";
		echo	"<h2>Upload to gallery</h2>";
		echo "</div>";
		echo "<div id=\"formLayout\">";
		echo "<FORM action=\"imgupload.php\" method=\"post\" id=\"form\" name=\"form\" enctype=\"multipart/form-data\">";
		echo	"<label for=\"fileToUpload\" id=\"uploadlab\">Select image to upload:</label>";
